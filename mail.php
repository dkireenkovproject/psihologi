...
try {
  ...
  $mail->Username   = 'd.kireenkov32rus@yandex.ru'; // Логин на почте
  $mail->Password   = 'oswmhuroccnfnsyo'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('d.kireenkov32rus@yandex.ru', 'Заявка с сайта ....'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('d.kireenkov@yandex.ru.ru');
